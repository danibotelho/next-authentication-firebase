...
{/*
-hidden sm:flex, informa que qndo o dispositivo for muito pequeno
    o botão deve sumir.
-hidden lg:flex informa que por padrão o texto será escondido e que qndo 
    atingir determinado tamanho , o texto irá aparecer 
*/}